...
namespace UnitTestProject2
{
    ...
    public class UnitTest1
    {
        ...
        public void Test1()
        {
            ...
            IWebElement news = driver.FindElement(By.XPath("//li[@class='orb-nav-newsdotcom']//a[contains(text(),'News')]"));
            news.Click(); 
        ...
        public void Test2()
        {
            ...
            List<string> themesNames = new List<string> { "UK teachers 'must get priority access to tests", "UN accuses Venezuela of crimes against humanity", "Smoke from US wildfires spreads across country", "Self-driving car operator charged over fatal crash", "Barbados to remove Queen as head of state" };
            int i = 0;
        ...
        public void Test3()
        {
            ...
            IWebElement headlineArticle = driver.FindElement(By.XPath("/html/body/div[7]/div/div[4]/div[2]/div/div/div/div/div[1]/div/div/div[1]/div/a"));
        ...
        public void Test4()
        {
            ...
            IWebElement news = driver.FindElement(By.XPath("//nav[@role='navigation']//a[contains(text(), 'News')]"));
            news.Click();
            ...
            IWebElement coronavirus = driver.FindElement(By.XPath("//nav[@class='nw-c-nav__wide']//a[@href='/news/coronavirus']"));
            coronavirus.Click();

            IWebElement coronavirusStories = driver.FindElement(By.XPath("//nav[contains(@class,'nw-c-nav__wide-secondary')]//a[@href='/news/have_your_say']"));
            coronavirusStories.Click();

            IWebElement sendQuestions = driver.FindElement(By.XPath("//a[@href='/news/52143212']"));
            sendQuestions.Click();
